 ...
 *       --config app.class=samza.examples.cookbook.JoinExample
 *       --config job.name=pageview-adclick-joiner
 ...
 *       --config job.config.loader.properties.path=$PWD/deploy/samza/config/join-example.properties
 *   </li>
 *   <li>
